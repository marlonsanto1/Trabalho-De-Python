...
frame_aluno = ctk.CTkFrame(root, corner_radius=10, border_width=2, border_color="lightblue")
...
frame_disciplina = ctk.CTkFrame(root, corner_radius=10, border_width=2, border_color="lightblue")
...
frame_notas = ctk.CTkFrame(root, corner_radius=10, border_width=2, border_color="lightblue")
frame_notas.grid(row=0, column=2, rowspan=2, padx=20, pady=20, sticky="nsew")
